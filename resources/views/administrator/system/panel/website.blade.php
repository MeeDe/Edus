    ...
    <div class="panel-body">
        <form class="form-horizontal" role="form" method="POST" action="">
            ...
            <div class="form-group{{ $errors->has('offline') ? ' has-error' : '' }}">
                <label class="col-md-4 control-label">{{ trans('dictionary.offline') }}</label>

                <div class="col-md-6">
                    <input type="text" class="form-control" name="offline" value="">
            ...
            <div class="form-group{{ $errors->has('offline_msg') ? ' has-error' : '' }}">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" name="offline_msg" value="">
